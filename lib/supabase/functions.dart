...
Future<void> signIn(context, String email, String password) async {
  ...
  if (response.error != null) {
    Fluttertoast.showToast(
      msg: "Login Gagal, Info : " + response.error!.message,
    ...
    Fluttertoast.showToast(msg: "Login Sukses", backgroundColor: Colors.green);
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => const BuyScreen()));
...
Future<void> signUp(context, String email, String password) async {
  ...
  if (response.error != null) {
    Fluttertoast.showToast(msg: "Gagal: " + response.error!.message);
